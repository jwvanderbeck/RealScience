...
latestReleaseURL = urllib.urlopen("https://api.github.com/repos/jwvanderbeck/RealScience/releases/0.1.3.0")
latestRelease = json.load(latestReleaseURL)
sinceDate = latestRelease["created_at"]
commitsURL = urllib.urlopen("https://api.github.com/repos/jwvanderbeck/RealScience/commits?since=" + sinceDate)
print "https://api.github.com/repos/jwvanderbeck/RealScience/commits?since=" + sinceDate
