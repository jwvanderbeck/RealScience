...
namespace RealScience
{
    internal class Styles
    {
        ...
        internal static void InitStyles()
        {
            ...
            stylePanel.normal.background = RealScience.Resources.texPanel;
            stylePanel.border = new RectOffset(6, 6, 6, 6);
            stylePanel.padding = new RectOffset(8, 3, 7, 0);

            stylePanelSolarizedDark = new GUIStyle();
            stylePanelSolarizedDark.normal.background = RealScience.Resources.texPanelSolarizedDark;
            ...
            styleTooltipStyle.normal.background = RealScience.Resources.texBox;
            ...
            styleDropDownListBox.normal.background = RealScience.Resources.texBox;
            //Extra border to prevent bleed of color - actual border is only 1 pixel wide
            ...
            stylePartWindowHead.normal.background = RealScience.Resources.texPartWindowHead;
            ...
            styleSeparatorV.normal.background = RealScience.Resources.texSeparatorV;
            styleSeparatorV.border = new RectOffset(0, 0, 6, 6);
            styleSeparatorV.fixedWidth = 2;

            styleSeparatorH = new GUIStyle();
            styleSeparatorH.normal.background = RealScience.Resources.texSeparatorH;
